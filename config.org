...
#+CAPTION: Uncle Dave's Emacs running in KDE
#+NAME:   screen.png
#+WEB   https://github.com/daedreth/UncleDavesEmacs
* Important note about this config 
- please visit Uncle Dave's Emacs for full and  original configuration.  https://github.com/daedreth/UncleDavesEmacs 
- I add/remove some of the addons.
- The font I am using is *Knack*
- remove the Sunrise Commander, because of the installation problem.
- added javascript 
- discord
- qutebrowser
- remove the media protion. 
* Keybinds 
Some of these Keybindings work only in exwm mode
| keys       | Functions                                            |                                                    |
|------------+------------------------------------------------------+----------------------------------------------------|
| s-r        | reset workspace                                      |                                                    |
| s-k        | delete workspaces                                    |                                                    |
| s-w        | swap workspace                                       |                                                    |
| s-<number> | switch to <number> workspace                         |                                                    |
| s-d        | launch Programms                                     |                                                    |
| s-spc      | dmenu                                                |                                                    |
| s-i        | toggle between line and char mode                    |                                                    |
| s-p        | toggle between char and mode for better copy/pasting | found on stackoverflow                             |
| C-x C-f    | toggle between char and line in ansi-term            |                                                    |
| s-h        | system monitor                                       |                                                    |
| <print>    | Screenshot                                           |                                                    |
| <f5>       | Projectile                                           | https://projectile.readthedocs.io/en/latest/usage/ |
| C-s        | swiper                                               |                                                    |
| C-'        | works  inside swiper menu                            |                                                    |
| M-x        | smex                                                 |                                                    |
| M-s        | search Text                                          |                                                    |
| C-c w k    | delete a word completely                             |                                                    |
| C-c w c    | cope a word completely                               |                                                    |
| C-c l k    | delete a Line                                        |                                                    |
| C-c e      | reload config.org File                               |                                                    |
| C-q        | select a region                                      |                                                    |
| C-c l c    | copy a Line                                          |                                                    |
| M-z        | delete till function                                 |                                                    |
| M-y        | popup paste                                          |                                                    |
| C-c '      | edit org mode                                        |                                                    |
...
| C-c p 4 t     | Jump to implementation or test file in other window.0                                                      |
...
#+BEGIN_SRC emacs-lisp
    (when window-system
          ...
          :ensure t
          :config
         (add-hook 'emacs-lisp 'turn-on-pretty-mode)
  ))
#+END_SRC
   ...
   (defun toggle-exwm-input-line-mode-passthrough ()
     (interactive)
      ...
      (force-mode-line-update))
          ...
          (exwm-input-set-key (kbd "s-p") 'toggle-exwm-input-line-mode-passthrough)     
  (exwm-input-set-key (kbd "s-c") #'list-processes)
(exwm-input-set-key (kbd "s-i") #'exwm-input-toggle-mode)
          ;; the next loop will bind s-<number> to switch to the corresponding Aworkspace
          (dotimes (i 10)
